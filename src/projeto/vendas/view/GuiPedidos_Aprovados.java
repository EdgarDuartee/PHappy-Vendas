    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        for(int i = 0; i < ListaPedidos.size(); i ++){
            if(ListaPedidos.get(i).getSituacao() == 1) {
                if(ListaPedidos.get(i).getClienteCod().substring(0, 1) == "PF") {
                    ...
                    //Falta Fazer o Método Consultar CLiente por CÓDIGO;
                    pj = daoPJuridica.consultaCNPJ(ListaPedidos.get(i).getClienteCod());
                    Object[] row = {ListaPedidos.get(i).getCodigo(),
